...
export class ProductDialogComponent implements OnInit {
  ...
  async validateAllFields(): Promise<boolean> {   // marcar todos como tocados e indica que se deben de llenar los campos
    if (this.formProduct.invalid) {       // . y nos aparece todos los metodos disponibles 
